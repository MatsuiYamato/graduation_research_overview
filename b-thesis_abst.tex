...
\setstretch{0.90}
    ...
    \abstract{We tested the effectiveness of the AutoMSRCR-based puddle detection method in an environment where a mobile robot is running.
    ...
    Therefore, we evaluated this method in the environment where the mobile robot runs, such as on a paved road surface or in an environment where the reflection of scenery is likely to occur.}
